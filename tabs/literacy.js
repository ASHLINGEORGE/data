// JavaScript for the HDI tab
document.addEventListener("DOMContentLoaded", function () {
  const hdiContent = document.getElementById("literacy-content");
      const data =[
          {
            "country": "Zimbabwe",
            "code": null,
            ...
            "gdp_percapita": null
                ...
                function updateBubbleChart(filteredData) {
                    ...
                    const bubbleData = filteredData.map(item => ({
                        ...
                        y: item.litreacy,
                        r: item.litreacy * 0.3, // Adjusted for visibility
                    ...
                    bubbleChart = new Chart(bubbleChartCtx, {
                        type: 'bubble', // Changed to 'bubble' type
                        data: {
                          datasets: [{
                    ...
                    options: {
                        scales: {
                            x: {
                                ...
                                title: {
                                    display: true,
                                    text: 'gdp_percapita', // Title for the x-axis
                            ...
                            y: {
                                ...
                                title: {
                                    display: true,
                                    text: 'Literacy Rate', // Title for the y-axis
                                    color: 'white', // Change the text color to white
                                    font: {
